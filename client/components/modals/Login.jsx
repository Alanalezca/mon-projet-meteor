            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header bgcolorC modalTopBordBotTransparent">
                        ...
                        <i className='bx bxs-x-square bxNormalOrange bxTopRight' ref={closeModalIconRef} data-bs-dismiss="modal"></i>
                    </div>
                    ...
                    <div className="modal-footer LoginModalBot">
                        <label className="subscribe" data-bs-toggle="modal" data-bs-target="#modalSubscribe">S'enregistrer</label><label> / </label><label>Mot de passe oublié</label>
